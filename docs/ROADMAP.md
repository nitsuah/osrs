...
- [x] **P0:** restore the Docker build: realign Python across Docker, CI and `pyproject.toml` after numpy 2.5.3 (#41) and the CI move to 3.12 (#42). See `docs/TASKS.md` (2026-09-24 PMO audit).
